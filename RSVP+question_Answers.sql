...
-- March month has the highest number of movies produced.
...
-- 1059 movies were made in INDIA or USA in the year 2019
...
-- Drama genre has more number of movies with 4285.
...
-- Action has the highest average duration as 112.88 
...
-- Thriller is 1494 movie count and genre_rank is 3. 
...
-- There are no outliers in the table
...
-- Rank 1 is shared by Kirket and Love in Kilnery 
...
-- Dream Warrior Pictures and National Theatre Live are in the 1st rank
...
GROUP BY median_rating;
-- Median rating is 8 and the movies are 361
...
-- Germany has more number of votes than Italy
...
-- James Mangold , Anthony Russo and Joe Russo are the top 3 directors in top 3 Genres.
...
-- Top Actors are Mammootty and Mohanlal. 
...
-- Top actor is Vijay Sethupathi followed by Fahadh Fasil and Yogi Babu.
...
-- Top 5 actresses in Indian movies are Taapsee Pannu, Kriti Sanon, Divya Dutta, Shraddha Kapoor, Kriti Kharbanda
